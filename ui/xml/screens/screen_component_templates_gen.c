/**
 * @file screen_component_templates_gen.c
...
#include "screen_component_templates_gen.h"
...
lv_obj_t * screen_component_templates_create(void)
{
    ...
    if (wristflow_ui_check_target(WRISTFLOW_UI_TARGET_ALL)) {
        ...
        lv_obj_set_name_static(lv_obj_0, "screen_component_templates_#");
        ...
        app_header_create(lv_obj_0, "新增页面");
