/**
 * @file screen_product_health_gen.c
...
#include "screen_product_health_gen.h"
...
lv_obj_t * screen_product_health_create(void)
{
    ...
    if (wristflow_ui_check_target(WRISTFLOW_UI_TARGET_ALL)) {
        ...
        lv_obj_set_name_static(lv_obj_0, "screen_product_health_#");
        ...
        lv_obj_t * slot_0 = card_container_create(tile_slots, "心率", "--", "", lv_color_hex(0xef4770), FG_PRIMARY, lv_color_hex(0xffffff), lv_color_hex(0xffffff));
        ...
        lv_obj_t * slot_1 = card_container_create(tile_slots, "血氧", "--", "", BG_SURFACE, FG_PRIMARY, FG_SECONDARY, lv_color_hex(0xef4770));
        ...
        lv_obj_t * slot_2 = card_container_create(tile_slots, "电量", "USB", "", BG_SURFACE, FG_PRIMARY, FG_SECONDARY, lv_color_hex(0x10b981));
        ...
        lv_obj_t * slot_3 = card_container_create(tile_slots, "压力", "--", "", lv_color_hex(0x38bdf8), FG_PRIMARY, lv_color_hex(0xffffff), lv_color_hex(0xffffff));
