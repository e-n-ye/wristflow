/**
 * @file screen_product_daily_gen.c
...
#include "screen_product_daily_gen.h"
...
lv_obj_t * screen_product_daily_create(void)
{
    ...
    if (wristflow_ui_check_target(WRISTFLOW_UI_TARGET_ALL)) {
        ...
        lv_obj_set_name_static(lv_obj_0, "screen_product_daily_#");
        ...
        lv_obj_t * slot_0 = metric_half_create(tile_slots, "天气", "--", "等待手机同步天气", "", BG_SURFACE, FG_PRIMARY, lv_color_hex(0x38bdf8));
        ...
        lv_obj_t * slot_1 = card_container_create(tile_slots, "睡眠", "--", "", lv_color_hex(0x388bfa), FG_PRIMARY, lv_color_hex(0xffffff), lv_color_hex(0xffffff));
        ...
        lv_obj_t * slot_2 = card_container_create(tile_slots, "闹钟", "--", "", BG_SURFACE, FG_PRIMARY, FG_SECONDARY, lv_color_hex(0x38bdf8));
