...
lv_obj_t * screen_tile_activity_create(void)
{
    ...
    if (wristflow_ui_check_target(WRISTFLOW_UI_TARGET_ALL)) {
        ...
        lv_obj_t * slot_0 = metric_half_create(tile_slots, "今日活动", "6,280", "目标 8,000 步", "", BG_SURFACE, FG_PRIMARY, ACCENT_GREEN);
        ...
        lv_obj_t * slot_1 = card_container_create(tile_slots, "距离 / 千米", "4.2", "", BG_SURFACE, FG_PRIMARY, FG_SECONDARY, lv_color_hex(0x67e1f7));
        ...
        lv_obj_t * slot_2 = card_container_create(tile_slots, "目标完成", "78%", "", lv_color_hex(0x67e1f7), lv_color_hex(0x09272c), lv_color_hex(0x234b54), lv_color_hex(0x09272c));
