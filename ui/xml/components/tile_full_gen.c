...
lv_obj_t * tile_full_create(lv_obj_t * parent)
{
    ...
    if (wristflow_ui_check_target(WRISTFLOW_UI_TARGET_ALL)) {
        ...
        lv_obj_set_name_static(lv_obj_0, "tile_full_#");
        ...
        lv_obj_set_style_grid_cell_row_span(lv_obj_0, 2, 0);
