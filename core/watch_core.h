...
typedef enum {
    ...
    WRISTFLOW_SURFACE_FACE_MANAGEMENT,
    WRISTFLOW_SURFACE_DISPLAY_SETTINGS,
    WRISTFLOW_SURFACE_BRIGHTNESS_SETTINGS,
    WRISTFLOW_SURFACE_BRIGHTNESS_ADJUST,
    WRISTFLOW_SURFACE_SCREEN_TIMEOUT,
    WRISTFLOW_SURFACE_KEEP_AWAKE,
    WRISTFLOW_SURFACE_SOUND_SETTINGS,
    WRISTFLOW_SURFACE_DND_SETTINGS,
    WRISTFLOW_SURFACE_NOTIFICATION_SETTINGS,
    WRISTFLOW_SURFACE_KEY_SETTINGS,
    WRISTFLOW_SURFACE_SYSTEM_SETTINGS,
    WRISTFLOW_SURFACE_ABOUT,
    WRISTFLOW_SURFACE_WAKE_SETTINGS,
